...
export const siteConfig: SiteConfig = {
	title: "硅步工作室 · Silicon Step Studio",
	subtitle: "AI 技术赋能 · 产品化 · 创造与探索",
	siteURL: "https://siliconstep.studio/", // 请替换为你的站点URL，以斜杠结尾
	keywords: ["硅步工作室", "Silicon Step Studio", "AI", "人工智能", "产品化", "南宁", "广西", "东盟", "出海", "SaaS", "教育", "创客"],
